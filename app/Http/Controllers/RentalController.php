...
class RentalController extends Controller
{
    ...
    public function update($id, Request $request)
    {
        ...
        // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
        DB::update(
            'UPDATE rental SET id_rental = :id_rental, id_customer = :id_customer, id_mobil = :id_mobil, id_sopir = :id_sopir, harga = :harga, tgl_rental = :tgl_rental, tgl_kembali = :tgl_kembali WHERE id_rental = :id',
            [
                'id' => $id,
    ...
    public function store(Request $request)
    {
        ...
        // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
        DB::insert(
            'INSERT INTO rental(id_rental, id_customer, id_mobil, id_sopir, harga, tgl_rental, tgl_kembali) VALUES (:id_rental, :id_customer, :id_mobil, :id_sopir, :harga, :tgl_rental, :tgl_kembali)',
            [
                'id_rental' => $request->id_rental,
                'id_customer' => $request->id_customer,
                'id_mobil' => $request->id_mobil,
