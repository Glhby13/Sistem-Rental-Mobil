...
<h4 class="mt-5">Data Trash mobil</h4>
<div class="form-search" style="float:right">
    <form action="{{ route('mobil.search_trash') }}" method="get" accept-charset="utf-8">
        <div class="form-group" style="display:flex">
            <input type="text" id="nama_mobil" name="nama_mobil" class="form-control" placeholder="Nama Mobil">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="float:right">
                <a href="{{ route('mobil.restore', $data->id_mobil) }}" type="button"
